...
import com.gitlab.dhorman.cryptotrader.exchangesdk.poloniexspot.core.PoloniexAdverseBuySellAmountCalculator
import com.gitlab.dhorman.cryptotrader.exchangesdk.poloniexspot.model.CurrencyType
...
import com.gitlab.dhorman.cryptotrader.robots.poloniexarbitrage.trader.core.PoloniexTradeAdjuster
import com.gitlab.dhorman.cryptotrader.robots.poloniexarbitrage.trader.model.*
...
class SplitTradeAlgoTest {
    ...
    fun `Received trade must completely fill partially completed market`() {
        ...
        val markets = Array.of(
            TranIntentMarketPartiallyCompleted(
                ...
                fromCurrencyType = com.gitlab.dhorman.cryptotrader.exchangesdk.poloniexspot.model.CurrencyType.Base,
                fromAmount = fromAmount
            ),
            TranIntentMarketPredicted(
                market = Market("USDC", "BTC"),
                fromCurrencyType = com.gitlab.dhorman.cryptotrader.exchangesdk.poloniexspot.model.CurrencyType.Quote,
    ...
    fun `Split markets with trade must return correct amounts`() {
        val markets: Array<TranIntentMarket> = Array.of(
            TranIntentMarketCompleted(
                market = Market("USDC", "USDT"), orderSpeed = OrderSpeed.Instant, fromCurrencyType = com.gitlab.dhorman.cryptotrader.exchangesdk.poloniexspot.model.CurrencyType.Base, trades = Array.of(
    ...
    fun `Correctly split markets by trade`() {
        val markets = Array.of(
            ...
            TranIntentMarketPredicted(market = Market("BTC", "STEEM"), orderSpeed = OrderSpeed.Instant, fromCurrencyType = com.gitlab.dhorman.cryptotrader.exchangesdk.poloniexspot.model.CurrencyType.Base),
            TranIntentMarketPredicted(market = Market("USDT", "STEEM"), orderSpeed = OrderSpeed.Delayed, fromCurrencyType = com.gitlab.dhorman.cryptotrader.exchangesdk.poloniexspot.model.CurrencyType.Quote)
        )
